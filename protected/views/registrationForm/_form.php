...
<?php $form=$this->beginWidget('CActiveForm', array(
 ...
 ?>
	...
	<div class="row">
		...
		<?php echo $form->textField($model,'facebook_profile_url',array('size'=>60,'maxlength'=>255)); ?>
        <p class="hint">(optional)</p>
	...
	<div class="row">
		<label>Go through this match: <a href="http://hitwicket.com/match/show/487237" target="_blank">http://hitwicket.com/match/show/487237</a> and write a 50-100 word match report on it, like a journalist.</label>
